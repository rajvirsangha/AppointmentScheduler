...
const Cosmic = require('consmicjs')
...
app.use(express.static(panth.join(_dirname, 'public')))
app.set('port', process.env.PORT || 3000)
app.post('/api/appointments', (req,res) => {
    // handle posting new appointments to Cosmic and sending a confirmation text with Twilio
